...
const Projects = () => {
  ...
  return (
    <>
        <Helmet>
        <title>
          Interior Design Projects in Bengaluru | Real Home Transformations
        </title>

        <meta
          name="description"
          content="Explore our completed interior design projects across Bengaluru. See real homes, modern designs, premium finishes and customized interior solutions."
        />

        <meta
          name="keywords"
          content="interior design projects bengaluru, completed interior works, home interior portfolio, modern interior designs, residential interior projects"
        />
      </Helmet>
