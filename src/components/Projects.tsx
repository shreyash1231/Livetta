...
const Projects = () => {
  ...
  return (
    <>
      <SEO
        title="Interior Design Projects in Bengaluru | Real Home Transformations"
        description="Explore our completed interior design projects across Bengaluru. See real homes, modern designs, premium finishes and customized interior solutions."
        keywords="interior design projects bengaluru, completed interior works, home interior portfolio, modern interior designs, residential interior projects"
      />
